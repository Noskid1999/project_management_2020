...
<head>
  ...
  <title>Reset The CHFOM Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #F6F6F6; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #F6F6F6; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #F6F6F6;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="http://localhost" style="mso-line-height-rule: exactly;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="">
                                  <img align="none" alt="" src="https://i.ibb.co/PD2rdZX/CHFOM-logo-with-Text.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: 100px; width: auto; margin: 0px;" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="http://localhost" style="mso-line-height-rule:
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="https://res.cloudinary.com/thedeltalabstechnologies/image/upload/v1585304916/il-password-reset_2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Please click on the "Reset Password" button to reset your password.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="{{ forgot_password_url }}" style="mso-line-height-rule: exactly;
 ...
 text-align: left; text-align: left; font-size: 14px; '>If you did not initiate this change, disregard this email or contact our system administrator at <a href="mailto:chfom.pm2020@gmail.com">chfom.pm2020@gmail.com</a>
                              </p>
